...
function setLogExtension(extension) {
  let logger = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : livekitLogger;
...
var RTPDrift = class _RTPDrift extends Message {
  constructor(data) {
    super();
    this.duration = 0;
  ...
  static equals(a, b) {
    return proto3.util.equals(_RTPDrift, a, b);
  }
};
...
function getLogContextFromTrack(track) {
  if (track instanceof Track) {
    ...
    return {
      ...
      track: track.track ? getLogContextFromTrack(track.track) : void 0,
...
var PCTransportManager = class {
  ...
  constructor(rtcConfig, subscriberPrimary, loggerOptions) {
    ...
    this.subscriber = new PCTransport(rtcConfig, void 0, loggerOptions);
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      if (encodings.length !== senderEncodings.length) {
        log2.warn("cannot set publishing layers, encodings mismatch");
        return;
      }
        ...
        if (isFireFox() && track.kind === Track.Kind.Audio) {
          ...
          if (trackTransceiver) {
            this.engine.pcManager.publisher.setTrackCodecBitrate({
              ...
              codec: "opus",
              maxbr: ((_m = encodings[0]) === null || _m === void 0 ? void 0 : _m.maxBitrate) ? encodings[0].maxBitrate / 1e3 : 0
            });
          }
...
var Room2 = class extends eventsExports.EventEmitter {
  ...
  sendSyncState() {
    const remoteTracks = Array.from(this.participants.values()).reduce((acc, participant) => {
      acc.push(...participant.getTracks());
      return acc;
    }, []);
    const localTracks = this.localParticipant.getTracks();
