...
declare type AudioSource = Track.Source.Microphone | Track.Source.ScreenShareAudio;
 ...
 * @public
 */
export declare function AudioTrack({ trackRef, onSubscriptionStatusChanged, volume, source, name, publication, participant: p, ...props }: AudioTrackProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function AudioVisualizer({ participant, trackRef, ...props }: AudioVisualizerProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ChatEntry({ entry, hideName, hideTimestamp, messageFormatter, ...props }: ChatEntryProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ChatToggle(props: ChatToggleProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ClearPinButton(props: ClearPinButtonProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ConnectionQualityIndicator(props: ConnectionQualityIndicatorProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ConnectionState({ room, ...props }: ConnectionStatusProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function DisconnectButton(props: DisconnectButtonProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function FocusLayout({ trackRef, track, ...htmlProps }: FocusLayoutProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function FocusToggle({ trackRef, trackSource, participant, ...props }: FocusToggleProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function LiveKitRoom(props: React_2.PropsWithChildren<LiveKitRoomProps>): React_2.JSX.Element;
 ...
 * @public
 */
export declare function MediaDeviceSelect({ kind, initialSelection, onActiveDeviceChange, onDeviceListChange, onDeviceSelectError, exactMatch, track, requestPermissions, onError, ...props }: MediaDeviceSelectProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ParticipantAudioTile({ participant, children, source, publication, disableSpeakingIndicator, onParticipantClick, ...htmlProps }: ParticipantTileProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ParticipantName({ participant, ...props }: ParticipantNameProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function ParticipantTile({ trackRef, participant, children, source, onParticipantClick, publication, disableSpeakingIndicator, ...htmlProps }: ParticipantTileProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function PreJoin({ defaults, onValidate, onSubmit, onError, debug, joinLabel, micLabel, camLabel, userLabel, showE2EEOptions, persistUserChoices, ...htmlProps }: PreJoinProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function RoomName({ childrenPosition, children, ...htmlAttributes }: RoomNameProps): React_2.JSX.Element;
 ...
 * @public
 */
export declare function StartAudio({ label, ...props }: AllowAudioPlaybackProps): React_2.JSX.Element;
 ...
 */
export declare const TrackContext: React_2.Context<TrackReferenceOrPlaceholder | undefined>;
 ...
 */
declare type TrackIdentifier<T extends Track.Source = Track.Source> = TrackSource<T> | TrackReference;
 ...
 * @public
 */
export declare function TrackMutedIndicator({ source, participant, trackRef, show, ...props }: TrackMutedIndicatorProps): React_2.JSX.Element | null;
...
declare type TrackSource<T extends Track.Source> = RequireAtLeastOne<{
    source: T;
    name: string;
    participant: Participant;
}, 'name' | 'source'>;
 ...
 * @public
 */
export declare function TrackToggle<T extends ToggleSource>({ showIcon, ...props }: TrackToggleProps<T>): React_2.JSX.Element;
...
/** @public */
export declare interface UseMediaTrackOptions {
...
/** @public */
export declare interface UseTrackMutedIndicatorOptions {
    /** @deprecated This parameter will be removed in a future version use `trackRef` instead. */
    participant?: Participant;
}

/** @public */
export declare interface UseTrackOptions {
    element?: React_2.RefObject<HTMLMediaElement>;
    props?: React_2.HTMLAttributes<HTMLVideoElement | HTMLAudioElement>;
}
 ...
 * @public
 */
export declare function VideoConference({ chatMessageFormatter, chatMessageDecoder, chatMessageEncoder, ...props }: VideoConferenceProps): React_2.JSX.Element;
...
declare type VideoSource = Track.Source.Camera | Track.Source.ScreenShare;
 ...
 * @public
 */
export declare function VideoTrack({ onTrackClick, onClick, onSubscriptionStatusChanged, trackRef, name, publication, source, participant: p, manageSubscription, ...props }: VideoTrackProps): React_2.JSX.Element;
