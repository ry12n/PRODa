...
function useChat(options) {
  ...
  React9.useEffect(() => {
    const setupChatReturn = (0, import_components_core4.setupChat)(room, options);
...
function useConnectionQualityIndicator(options = {}) {
  ...
  const { className, connectionQualityObserver } = React12.useMemo(
    () => (0, import_components_core5.setupConnectionQualityIndicator)(p),
    [p]
  );
...
function useConnectionState(room) {
  ...
  const observable = React13.useMemo(() => (0, import_components_core6.connectionStateObserver)(r), [r]);
...
function useParticipantTile({
  ...
  const p = useEnsureParticipant(participant);
  const trackReference = React25.useMemo(() => {
...
function useStartAudio({ room, props }) {
  ...
  const { className, roomAudioPlaybackAllowedObservable, handleStartAudioPlayback } = React27.useMemo(
...
function useStartVideo({ room, props }) {
  const roomEnsured = useEnsureRoom(room);
  const { className, roomVideoPlaybackAllowedObservable, handleStartVideoPlayback } = React28.useMemo(
...
function useTrackToggle(_a) {
  ...
  const userInteractionRef = React32.useRef(false);
...
function usePersistentUserChoices(options = {}) {
  var _a;
  const [userChoices, setSettings] = React34.useState(
    (0, import_components_core25.loadUserChoices)(options.defaults, (_a = options.preventLoad) != null ? _a : false)
  );
  const saveAudioInputEnabled = React34.useCallback((isEnabled) => {
    setSettings((prev) => __spreadProps(__spreadValues({}, prev), { audioEnabled: isEnabled }));
  }, []);
  const saveVideoInputEnabled = React34.useCallback((isEnabled) => {
    setSettings((prev) => __spreadProps(__spreadValues({}, prev), { videoEnabled: isEnabled }));
  }, []);
  const saveAudioInputDeviceId = React34.useCallback((deviceId) => {
    setSettings((prev) => __spreadProps(__spreadValues({}, prev), { audioDeviceId: deviceId }));
  }, []);
  const saveVideoInputDeviceId = React34.useCallback((deviceId) => {
    setSettings((prev) => __spreadProps(__spreadValues({}, prev), { videoDeviceId: deviceId }));
  }, []);
  const saveUsername = React34.useCallback((username) => {
    setSettings((prev) => __spreadProps(__spreadValues({}, prev), { username }));
  }, []);
  React34.useEffect(() => {
    var _a2;
    (0, import_components_core25.saveUserChoices)(userChoices, (_a2 = options.preventSave) != null ? _a2 : false);
...
function useIsEncrypted(participant) {
  ...
  const observer = React35.useMemo(() => (0, import_components_core26.encryptionStatusObservable)(room, p), [room, p]);
  const isEncrypted = useObservableState(
    observer,
    p instanceof import_livekit_client6.LocalParticipant ? p.isE2EEEnabled : p.isEncrypted
  );
  return isEncrypted;
}
...
var useMultibandTrackVolume = (trackOrTrackReference, options = {}) => {
  var _a;
  const track = trackOrTrackReference instanceof import_livekit_client7.Track ? trackOrTrackReference : (_a = trackOrTrackReference == null ? void 0 : trackOrTrackReference.publication) == null ? void 0 : _a.track;
  const [frequencyBands, setFrequencyBands] = React36.useState([]);
...
function ChatToggle(props) {
  ...
  return /* @__PURE__ */ React37.createElement("button", __spreadValues({}, mergedProps), props.children);
}
...
function DisconnectButton(props) {
  ...
  return /* @__PURE__ */ React38.createElement("button", __spreadValues({}, buttonProps), props.children);
}
...
var SvgCameraDisabledIcon = (props) => /* @__PURE__ */ React39.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React39.createElement("path", { d: "M1.354.646a.5.5 0 1 0-.708.708l14 14a.5.5 0 0 0 .708-.708L11 10.293V4.5A1.5 1.5 0 0 0 9.5 3H3.707zM0 4.5a1.5 1.5 0 0 1 .943-1.393l9.532 9.533c-.262.224-.603.36-.975.36h-8A1.5 1.5 0 0 1 0 11.5z" }), /* @__PURE__ */ React39.createElement("path", { d: "m15.2 3.6-2.8 2.1a1 1 0 0 0-.4.8v3a1 1 0 0 0 .4.8l2.8 2.1a.5.5 0 0 0 .8-.4V4a.5.5 0 0 0-.8-.4z" }));
var CameraDisabledIcon_default = SvgCameraDisabledIcon;

// src/assets/icons/CameraIcon.tsx
var React40 = __toESM(require("react"));
var SvgCameraIcon = (props) => /* @__PURE__ */ React40.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "currentColor" }, props), /* @__PURE__ */ React40.createElement("path", { d: "M0 4.5A1.5 1.5 0 0 1 1.5 3h8A1.5 1.5 0 0 1 11 4.5v7A1.5 1.5 0 0 1 9.5 13h-8A1.5 1.5 0 0 1 0 11.5zM15.2 3.6l-2.8 2.1a1 1 0 0 0-.4.8v3a1 1 0 0 0 .4.8l2.8 2.1a.5.5 0 0 0 .8-.4V4a.5.5 0 0 0-.8-.4z" }));
var CameraIcon_default = SvgCameraIcon;

// src/assets/icons/ChatCloseIcon.tsx
var React41 = __toESM(require("react"));
var SvgChatCloseIcon = (props) => /* @__PURE__ */ React41.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, viewBox: "0 0 24 24" }, props), /* @__PURE__ */ React41.createElement(
  "path",
  {
    fill: "#FFF",
...
var SvgChatIcon = (props) => /* @__PURE__ */ React42.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 18, fill: "none" }, props), /* @__PURE__ */ React42.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var SvgChevron = (props) => /* @__PURE__ */ React43.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React43.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var SvgFocusToggleIcon = (props) => /* @__PURE__ */ React44.createElement("svg", __spreadValues({ xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none" }, props), /* @__PURE__ */ React44.createElement("g", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5 }, /* @__PURE__ */ React44.createElement("path", { d: "M10 1.75h4.25m0 0V6m0-4.25L9 7M6 14.25H1.75m0 0V10m0 4.25L7 9" })));
...
function FocusToggle(_a) {
  ...
  return /* @__PURE__ */ React57.createElement(LayoutContext.Consumer, null, (layoutContext) => layoutContext !== void 0 && /* @__PURE__ */ React57.createElement("button", __spreadValues({}, mergedProps), props.children ? props.children : inFocus ? /* @__PURE__ */ React57.createElement(UnfocusToggleIcon_default, null) : /* @__PURE__ */ React57.createElement(FocusToggleIcon_default, null)));
}
...
function MediaDeviceSelect(_a) {
  ...
  const handleError = React58.useCallback(
    (e) => {
      if (room) {
        room.emit(import_livekit_client8.RoomEvent.MediaDevicesError, e);
      }
  ...
  return /* @__PURE__ */ React58.createElement("ul", __spreadValues({}, mergedProps), devices.map((device, index) => /* @__PURE__ */ React58.createElement(
    "li",
    {
      key: device.deviceId,
      id: device.deviceId,
...
function TrackToggle(_a) {
  ...
  return /* @__PURE__ */ React60.createElement("button", __spreadValues({}, buttonProps), (showIcon != null ? showIcon : true) && getSourceIcon(props.source, enabled), props.children);
}
...
function ConnectionQualityIndicator(props) {
  ...
  return /* @__PURE__ */ React61.createElement("div", __spreadValues({}, elementProps), (_a = props.children) != null ? _a : getConnectionQualityIcon(quality));
}
...
function ParticipantName(_a) {
  ...
  return /* @__PURE__ */ React62.createElement("span", __spreadValues({}, mergedProps), name !== "" ? name : identity, props.children);
}
...
function TrackMutedIndicator(_a) {
  ...
  return /* @__PURE__ */ React63.createElement("div", __spreadProps(__spreadValues({}, htmlProps), { "data-lk-muted": isMuted }), (_b2 = props.children) != null ? _b2 : getSourceIcon((_a2 = trackRef == null ? void 0 : trackRef.source) != null ? _a2 : source, !isMuted));
}
...
function VideoTrack(_a) {
  ...
  const mediaEl = React65.useRef(null);
  ...
  return /* @__PURE__ */ React65.createElement("video", __spreadProps(__spreadValues({ ref: mediaEl }, elementProps), { muted: true, onClick: clickHandler }));
}
...
function AudioTrack(_a) {
  ...
  React66.useEffect(() => {
    ...
    if (track instanceof import_livekit_client11.RemoteAudioTrack) {
  ...
  React66.useEffect(() => {
    ...
    if (pub instanceof import_livekit_client11.RemoteTrackPublication) {
  ...
  return /* @__PURE__ */ React66.createElement("audio", __spreadValues({ ref: mediaEl }, elementProps));
}

// src/components/participant/ParticipantTile.tsx
function ParticipantContextIfNeeded(props) {
  const hasContext = !!useMaybeParticipantContext();
  return props.participant && !hasContext ? /* @__PURE__ */ React67.createElement(ParticipantContext.Provider, { value: props.participant }, props.children) : /* @__PURE__ */ React67.createElement(React67.Fragment, null, props.children);
}
function TrackRefContextIfNeeded(props) {
  const hasContext = !!useMaybeTrackRefContext();
  return props.trackRef && !hasContext ? /* @__PURE__ */ React67.createElement(TrackRefContext.Provider, { value: props.trackRef }, props.children) : /* @__PURE__ */ React67.createElement(React67.Fragment, null, props.children);
}
function ParticipantTile(_a) {
  ...
  const maybeTrackRef = useMaybeTrackRefContext();
  const p = useEnsureParticipant(participant);
  const trackReference = React67.useMemo(() => {
  ...
  const handleSubscribe = React67.useCallback(
    (subscribed) => {
  ...
  return /* @__PURE__ */ React67.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React67.createElement(TrackRefContextIfNeeded, { trackRef: trackReference }, /* @__PURE__ */ React67.createElement(ParticipantContextIfNeeded, { participant: trackReference.participant }, children != null ? children : /* @__PURE__ */ React67.createElement(React67.Fragment, null, (0, import_components_core30.isTrackReference)(trackReference) && (((_b2 = trackReference.publication) == null ? void 0 : _b2.kind) === "video" || trackReference.source === import_livekit_client12.Track.Source.Camera || trackReference.source === import_livekit_client12.Track.Source.ScreenShare) ? /* @__PURE__ */ React67.createElement(
    VideoTrack,
    {
  ...
  ) : (0, import_components_core30.isTrackReference)(trackReference) && /* @__PURE__ */ React67.createElement(
    AudioTrack,
    {
      trackRef: trackReference,
      onSubscriptionStatusChanged: handleSubscribe
    }
  ), /* @__PURE__ */ React67.createElement("div", { className: "lk-participant-placeholder" }, /* @__PURE__ */ React67.createElement(ParticipantPlaceholder_default, null)), /* @__PURE__ */ React67.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React67.createElement("div", { className: "lk-participant-metadata-item" }, trackReference.source === import_livekit_client12.Track.Source.Camera ? /* @__PURE__ */ React67.createElement(React67.Fragment, null, isEncrypted && /* @__PURE__ */ React67.createElement(LockLockedIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React67.createElement(
    TrackMutedIndicator,
    {
      source: import_livekit_client12.Track.Source.Microphone,
      show: "muted"
    }
  ), /* @__PURE__ */ React67.createElement(ParticipantName, null)) : /* @__PURE__ */ React67.createElement(React67.Fragment, null, /* @__PURE__ */ React67.createElement(ScreenShareIcon_default, { style: { marginRight: "0.25rem" } }), /* @__PURE__ */ React67.createElement(ParticipantName, null, "'s screen"))), /* @__PURE__ */ React67.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" }))), /* @__PURE__ */ React67.createElement(FocusToggle, { trackRef: trackReference }))));
}

// src/components/layout/FocusLayout.tsx
function FocusLayoutContainer(props) {
  const elementProps = mergeProps2(props, { className: "lk-focus-layout" });
  return /* @__PURE__ */ React68.createElement("div", __spreadValues({}, elementProps), props.children);
}
function FocusLayout(_a) {
  ...
  return /* @__PURE__ */ React68.createElement(ParticipantTile, __spreadValues(__spreadValues({}, trackReference), htmlProps));
}
...
function TrackLoop(_a) {
  ...
  return /* @__PURE__ */ React69.createElement(React69.Fragment, null, tracks.map((trackReference) => {
...
function PaginationControl({
  ...
  const [interactive, setInteractive] = React70.useState(false);
  React70.useEffect(() => {
    let subscription;
    if (connectedElement) {
  ...
  return /* @__PURE__ */ React70.createElement("div", { className: "lk-pagination-control", "data-lk-user-interaction": interactive }, /* @__PURE__ */ React70.createElement("button", { className: "lk-button", onClick: prevPage }, /* @__PURE__ */ React70.createElement(Chevron_default, null)), /* @__PURE__ */ React70.createElement("span", { className: "lk-pagination-count" }, `${currentPage} of ${totalPageCount}`), /* @__PURE__ */ React70.createElement("button", { className: "lk-button", onClick: nextPage }, /* @__PURE__ */ React70.createElement(Chevron_default, null)));
}
...
function PaginationIndicator({ totalPageCount, currentPage }) {
  const bubbles = new Array(totalPageCount).fill("").map((_, index) => {
    if (index + 1 === currentPage) {
      return /* @__PURE__ */ React71.createElement("span", { "data-lk-active": true, key: index });
    } else {
      return /* @__PURE__ */ React71.createElement("span", { key: index });
    }
  });
  return /* @__PURE__ */ React71.createElement("div", { className: "lk-pagination-indicator" }, bubbles);
}

// src/components/layout/GridLayout.tsx
function GridLayout(_a) {
  var _b = _a, { tracks } = _b, props = __objRest(_b, ["tracks"]);
  const gridEl = React72.createRef();
  ...
  return /* @__PURE__ */ React72.createElement("div", __spreadValues({ ref: gridEl, "data-lk-pagination": pagination.totalPageCount > 1 }, elementProps), /* @__PURE__ */ React72.createElement(TrackLoop, { tracks: pagination.tracks }, props.children), tracks.length > layout.maxTiles && /* @__PURE__ */ React72.createElement(React72.Fragment, null, /* @__PURE__ */ React72.createElement(
    PaginationIndicator,
    {
      totalPageCount: pagination.totalPageCount,
      currentPage: pagination.currentPage
    }
  ), /* @__PURE__ */ React72.createElement(PaginationControl, __spreadValues({ pagesContainer: gridEl }, pagination))));
}
...
function CarouselLayout(_a) {
  ...
  const asideEl = React73.useRef(null);
  const [prevTiles, setPrevTiles] = React73.useState(0);
  ...
  return /* @__PURE__ */ React73.createElement("aside", __spreadValues({ key: carouselOrientation, className: "lk-carousel", ref: asideEl }, props), /* @__PURE__ */ React73.createElement(TrackLoop, { tracks: sortedTiles }, props.children));
}
...
function LayoutContextProvider({
  ...
  return /* @__PURE__ */ React74.createElement(LayoutContext.Provider, { value: layoutContextValue }, children);
}
...
function AudioVisualizer(_a) {
  ...
  return /* @__PURE__ */ React75.createElement(
    ...
    /* @__PURE__ */ React75.createElement("rect", { x: "0", y: "0", width: "100%", height: "100%" }),
    /* @__PURE__ */ React75.createElement(
      ...
      volumes.map((vol, idx) => /* @__PURE__ */ React75.createElement(
        "rect",
        {
          key: idx,
...
function RoomAudioRenderer({ volume, muted }) {
  ...
  return /* @__PURE__ */ React76.createElement("div", { style: { display: "none" } }, tracks.map((trackRef) => /* @__PURE__ */ React76.createElement(
    AudioTrack,
    {
...
function Toast(props) {
  const htmlProps = React77.useMemo(() => mergeProps2(props, { className: "lk-toast" }), [props]);
  return /* @__PURE__ */ React77.createElement("div", __spreadValues({}, htmlProps), props.children);
}
...
function ParticipantAudioTile(_a) {
  ...
  return /* @__PURE__ */ React78.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React78.createElement(ParticipantContextIfNeeded, { participant: p }, children != null ? children : /* @__PURE__ */ React78.createElement(React78.Fragment, null, /* @__PURE__ */ React78.createElement(AudioTrack, { source: source != null ? source : import_livekit_client15.Track.Source.Microphone }), /* @__PURE__ */ React78.createElement(AudioVisualizer, null), /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React78.createElement(TrackMutedIndicator, { source: import_livekit_client15.Track.Source.Microphone }), /* @__PURE__ */ React78.createElement(ParticipantName, null)), /* @__PURE__ */ React78.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
function ConnectionStateToast(props) {
  const [notification, setNotification] = React79.useState(void 0);
  const state = useConnectionState(props.room);
  React79.useEffect(() => {
    switch (state) {
      case import_livekit_client16.ConnectionState.Reconnecting:
        setNotification(
          /* @__PURE__ */ React79.createElement(React79.Fragment, null, /* @__PURE__ */ React79.createElement(SpinnerIcon_default, { className: "lk-spinner" }), " Reconnecting")
        );
        break;
      case import_livekit_client16.ConnectionState.Connecting:
        setNotification(
          /* @__PURE__ */ React79.createElement(React79.Fragment, null, /* @__PURE__ */ React79.createElement(SpinnerIcon_default, { className: "lk-spinner" }), " Connecting")
        );
        break;
      case import_livekit_client16.ConnectionState.Disconnected:
        setNotification(/* @__PURE__ */ React79.createElement(React79.Fragment, null, "Disconnected"));
        break;
      default:
  ...
  return notification ? /* @__PURE__ */ React79.createElement(Toast, { className: "lk-toast-connection-state" }, notification) : /* @__PURE__ */ React79.createElement(React79.Fragment, null);
}
...
function Chat(_a) {
  ...
  const ulRef = React80.useRef(null);
  const chatOptions = React80.useMemo(() => {
    return { messageDecoder, messageEncoder, channelTopic };
  }, [messageDecoder, messageEncoder, channelTopic]);
  const { send, chatMessages, isSending } = useChat(chatOptions);
  const layoutContext = useMaybeLayoutContext();
  const lastReadMsgAt = React80.useRef(0);
  ...
  return /* @__PURE__ */ React80.createElement("div", __spreadProps(__spreadValues({}, props), { className: "lk-chat" }), /* @__PURE__ */ React80.createElement("div", { className: "lk-chat-header" }, "Messages", /* @__PURE__ */ React80.createElement(ChatToggle, { className: "lk-close-button" }, /* @__PURE__ */ React80.createElement(ChatCloseIcon_default, null))), /* @__PURE__ */ React80.createElement("ul", { className: "lk-list lk-chat-messages", ref: ulRef }, props.children ? chatMessages.map(
    (msg, idx) => {
      var _a2;
  ...
  })), /* @__PURE__ */ React80.createElement("form", { className: "lk-chat-form", onSubmit: handleSubmit }, /* @__PURE__ */ React80.createElement(
    "input",
    {
  ...
  ), /* @__PURE__ */ React80.createElement("button", { type: "submit", className: "lk-button lk-chat-form-button", disabled: isSending }, "Send")));
}
...
function MediaDeviceMenu(_a) {
  ...
  const [devices, setDevices] = React81.useState([]);
  const [updateRequired, setUpdateRequired] = React81.useState(true);
  const handleActiveDeviceChange = (kind2, deviceId) => {
    import_components_core37.log.debug("handle device change");
    setIsOpen(false);
    onActiveDeviceChange == null ? void 0 : onActiveDeviceChange(kind2, deviceId);
  };
  const button = React81.useRef(null);
  const tooltip = React81.useRef(null);
  React81.useLayoutEffect(() => {
    if (button.current && tooltip.current && (devices || updateRequired)) {
      (0, import_components_core36.computeMenuPosition)(button.current, tooltip.current).then(({ x, y }) => {
        if (tooltip.current) {
  ...
  const handleClickOutside = React81.useCallback(
    (event) => {
      if (!tooltip.current) {
        return;
      }
      ...
      if (isOpen && (0, import_components_core36.wasClickOutside)(tooltip.current, event)) {
        setIsOpen(false);
      }
    },
  ...
  return /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(
    ...
    props.children
  ), !props.disabled && /* @__PURE__ */ React81.createElement(
    "div",
    {
    ...
    kind ? /* @__PURE__ */ React81.createElement(
      MediaDeviceSelect,
      {
        initialSelection,
    ...
    ) : /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement("div", { className: "lk-device-menu-heading" }, "Audio inputs"), /* @__PURE__ */ React81.createElement(
      MediaDeviceSelect,
      {
        kind: "audioinput",
    ...
    ), /* @__PURE__ */ React81.createElement("div", { className: "lk-device-menu-heading" }, "Video inputs"), /* @__PURE__ */ React81.createElement(
      MediaDeviceSelect,
      {
        kind: "videoinput",
...
function usePreviewTracks(options, onError) {
  const [tracks, setTracks] = React83.useState();
  React83.useEffect(() => {
    let trackPromise = void 0;
    let needsCleanup = false;
    if (options.audio || options.video) {
      trackPromise = (0, import_livekit_client17.createLocalTracks)(options);
...
function usePreviewDevice(enabled, deviceId, kind) {
  const [deviceError, setDeviceError] = React83.useState(null);
  const [isCreatingTrack, setIsCreatingTrack] = React83.useState(false);
  const devices = useMediaDevices({ kind });
  const [selectedDevice, setSelectedDevice] = React83.useState(
    void 0
  );
  const [localTrack, setLocalTrack] = React83.useState();
  const [localDeviceId, setLocalDeviceId] = React83.useState(deviceId);
  React83.useEffect(() => {
  ...
  const prevDeviceId = React83.useRef(localDeviceId);
  React83.useEffect(() => {
    if (enabled && !localTrack && !deviceError && !isCreatingTrack) {
      import_components_core38.log.debug("creating track", kind);
  ...
  React83.useEffect(() => {
    ...
    if (!enabled) {
      import_components_core38.log.debug(`muting ${kind} track`);
      localTrack.mute().then(() => import_components_core38.log.debug(localTrack.mediaStreamTrack));
      ...
      import_components_core38.log.debug(`switching ${kind} device from`, prevDeviceId.current, selectedDevice.deviceId);
      switchDevice(localTrack, selectedDevice.deviceId);
    } else {
      import_components_core38.log.debug(`unmuting local ${kind} track`);
      localTrack.unmute();
    }
  ...
  React83.useEffect(() => {
    return () => {
      if (localTrack) {
        import_components_core38.log.debug(`stopping local ${kind} track`);
        localTrack.stop();
        localTrack.mute();
      }
    };
...
function PreJoin(_a) {
  ...
  var _a2, _b2;
  const [userChoices, setUserChoices] = React83.useState(DEFAULT_USER_CHOICES);
  ...
  const [audioEnabled, setAudioEnabled] = React83.useState(initialUserChoices.audioEnabled);
  const [videoEnabled, setVideoEnabled] = React83.useState(initialUserChoices.videoEnabled);
  const [audioDeviceId, setAudioDeviceId] = React83.useState(
    initialUserChoices.audioDeviceId
  );
  const [videoDeviceId, setVideoDeviceId] = React83.useState(
    initialUserChoices.videoDeviceId
  );
  const [username, setUsername] = React83.useState(initialUserChoices.username);
  const [e2ee, setE2ee] = React83.useState((_a2 = defaults.e2ee) != null ? _a2 : DEFAULT_USER_CHOICES.e2ee);
  const [sharedPassphrase, setSharedPassphrase] = React83.useState(
  ...
  const videoEl = React83.useRef(null);
  const videoTrack = React83.useMemo(
    () => tracks == null ? void 0 : tracks.filter((track) => track.kind === import_livekit_client17.Track.Kind.Video)[0],
    [tracks]
  );
  const facingMode = React83.useMemo(() => {
    if (videoTrack) {
  ...
  const audioTrack = React83.useMemo(
  ...
  const [isValid, setIsValid] = React83.useState();
  const handleValidation = React83.useCallback(
    (values) => {
  ...
  function handleSubmit(event) {
    ...
    if (handleValidation(userChoices)) {
      ...
      import_components_core38.log.warn("Validation failed with: ", userChoices);
    }
  }
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React83.createElement("div", __spreadValues({ className: "lk-prejoin" }, htmlProps), /* @__PURE__ */ React83.createElement("div", { className: "lk-video-container" }, videoTrack && /* @__PURE__ */ React83.createElement("video", { ref: videoEl, width: "1280", height: "720", "data-lk-facing-mode": facingMode }), (!videoTrack || !videoEnabled) && /* @__PURE__ */ React83.createElement("div", { className: "lk-camera-off-note" }, /* @__PURE__ */ React83.createElement(ParticipantPlaceholder_default, null))), /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group-container" }, /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group audio" }, /* @__PURE__ */ React83.createElement(
    TrackToggle,
    {
    ...
    micLabel
  ), /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React83.createElement(
    MediaDeviceMenu,
    {
  ...
  ))), /* @__PURE__ */ React83.createElement("div", { className: "lk-button-group video" }, /* @__PURE__ */ React83.createElement(
    TrackToggle,
    {
  ...
  )))), /* @__PURE__ */ React83.createElement("form", { className: "lk-username-container" }, /* @__PURE__ */ React83.createElement(
    "input",
    {
  ...
  ), showE2EEOptions && /* @__PURE__ */ React83.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" } }, /* @__PURE__ */ React83.createElement("div", { style: { display: "flex", flexDirection: "row", gap: "1rem" } }, /* @__PURE__ */ React83.createElement(
    "input",
    {
      id: "use-e2ee",
      type: "checkbox",
  ...
  ), /* @__PURE__ */ React83.createElement("label", { htmlFor: "use-e2ee" }, "Enable end-to-end encryption")), e2ee && /* @__PURE__ */ React83.createElement("div", { style: { display: "flex", flexDirection: "row", gap: "1rem" } }, /* @__PURE__ */ React83.createElement("label", { htmlFor: "passphrase" }, "Passphrase"), /* @__PURE__ */ React83.createElement(
    "input",
    {
      id: "passphrase",
      type: "password",
    ...
    joinLabel
  )), debug && /* @__PURE__ */ React83.createElement(React83.Fragment, null, /* @__PURE__ */ React83.createElement("strong", null, "User Choices:"), /* @__PURE__ */ React83.createElement("ul", { className: "lk-list", style: { overflow: "hidden", maxWidth: "15rem" } }, /* @__PURE__ */ React83.createElement("li", null, "Username: ", `${userChoices.username}`), /* @__PURE__ */ React83.createElement("li", null, "Video Enabled: ", `${userChoices.videoEnabled}`), /* @__PURE__ */ React83.createElement("li", null, "Audio Enabled: ", `${userChoices.audioEnabled}`), /* @__PURE__ */ React83.createElement("li", null, "Video Device: ", `${userChoices.videoDeviceId}`), /* @__PURE__ */ React83.createElement("li", null, "Audio Device: ", `${userChoices.audioDeviceId}`))));
}
...
function StartMediaButton(_a) {
  ...
  return /* @__PURE__ */ React84.createElement("button", __spreadValues({ style }, restProps), label != null ? label : `Start ${!canPlayAudio ? "Audio" : "Video"}`);
}
...
function ControlBar(_a) {
  ...
  var _a2, _b2, _c, _d, _e;
  const [isChatOpen, setIsChatOpen] = React85.useState(false);
  const layoutContext = useMaybeLayoutContext();
  React85.useEffect(() => {
    var _a3, _b3;
  ...
  const showIcon = React85.useMemo(
    () => variation === "minimal" || variation === "verbose",
    [variation]
  );
  const showText = React85.useMemo(
    () => variation === "textOnly" || variation === "verbose",
    [variation]
  );
  const browserSupportsScreenSharing = (0, import_components_core39.supportsScreenSharing)();
  const [isScreenShareEnabled, setIsScreenShareEnabled] = React85.useState(false);
  const onScreenShareChange = React85.useCallback(
    (enabled) => {
  ...
  const microphoneOnChange = React85.useCallback(
    (enabled, isUserInitiated) => isUserInitiated ? saveAudioInputEnabled(enabled) : null,
    [saveAudioInputEnabled]
  );
  const cameraOnChange = React85.useCallback(
    (enabled, isUserInitiated) => isUserInitiated ? saveVideoInputEnabled(enabled) : null,
    [saveVideoInputEnabled]
  );
  return /* @__PURE__ */ React85.createElement("div", __spreadValues({}, htmlProps), visibleControls.microphone && /* @__PURE__ */ React85.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React85.createElement(
    TrackToggle,
    {
    ...
    showText && "Microphone"
  ), /* @__PURE__ */ React85.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React85.createElement(
    MediaDeviceMenu,
    {
      kind: "audioinput",
      onActiveDeviceChange: (_kind, deviceId) => saveAudioInputDeviceId(deviceId != null ? deviceId : "")
    }
  ))), visibleControls.camera && /* @__PURE__ */ React85.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React85.createElement(TrackToggle, { source: import_livekit_client18.Track.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React85.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React85.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
      onActiveDeviceChange: (_kind, deviceId) => saveVideoInputDeviceId(deviceId != null ? deviceId : "")
    }
  ))), visibleControls.screenShare && browserSupportsScreenSharing && /* @__PURE__ */ React85.createElement(
    TrackToggle,
    {
      source: import_livekit_client18.Track.Source.ScreenShare,
      captureOptions: { audio: true, selfBrowserSurface: "include" },
      showIcon,
      onChange: onScreenShareChange
    },
    showText && (isScreenShareEnabled ? "Stop screen share" : "Share screen")
  ), visibleControls.chat && /* @__PURE__ */ React85.createElement(ChatToggle, null, showIcon && /* @__PURE__ */ React85.createElement(ChatIcon_default, null), showText && "Chat"), visibleControls.leave && /* @__PURE__ */ React85.createElement(DisconnectButton, null, showIcon && /* @__PURE__ */ React85.createElement(LeaveIcon_default, null), showText && "Leave"), /* @__PURE__ */ React85.createElement(StartMediaButton, null));
}
...
function VideoConference(_a) {
  ...
  const lastAutoFocusedScreenShareTrack = React86.useRef(null);
  const tracks = useTracks(
    [
  ...
  const screenShareTracks = tracks.filter(import_components_core40.isTrackReference).filter((track) => track.publication.source === import_livekit_client19.Track.Source.ScreenShare);
  const focusTrack = (_a2 = usePinnedTracks(layoutContext)) == null ? void 0 : _a2[0];
  const carouselTracks = tracks.filter((track) => !(0, import_components_core40.isEqualTrackRef)(track, focusTrack));
  React86.useEffect(() => {
    var _a3, _b3, _c, _d;
