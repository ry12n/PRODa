...
function useIsEncrypted(participant) {
  ...
  const observer = React35.useMemo(() => encryptionStatusObservable(room, p), [room, p]);
...
function ParticipantAudioTile(_a) {
  ...
  return /* @__PURE__ */ React78.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React78.createElement(ParticipantContextIfNeeded, { participant: p }, children != null ? children : /* @__PURE__ */ React78.createElement(React78.Fragment, null, /* @__PURE__ */ React78.createElement(AudioTrack, { source: source != null ? source : Track8.Source.Microphone }), /* @__PURE__ */ React78.createElement(AudioVisualizer, null), /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React78.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React78.createElement(TrackMutedIndicator, { source: Track8.Source.Microphone }), /* @__PURE__ */ React78.createElement(ParticipantName, null)), /* @__PURE__ */ React78.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
import { isEqualTrackRef, isTrackReference as isTrackReference4, isWeb, log as log11 } from "@livekit/components-core";
...
function ControlBar(_a) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React85.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React85.createElement(TrackToggle, { source: Track10.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React85.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React85.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
function VideoConference(_a) {
  ...
  useWarnAboutMissingStyles();
  return /* @__PURE__ */ React86.createElement("div", __spreadValues({ className: "lk-video-conference" }, props), isWeb() && /* @__PURE__ */ React86.createElement(
