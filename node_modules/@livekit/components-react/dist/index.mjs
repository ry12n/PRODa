...
function ParticipantAudioTile(_a) {
  ...
  return /* @__PURE__ */ React97.createElement("div", __spreadValues({ style: { position: "relative" } }, elementProps), /* @__PURE__ */ React97.createElement(ParticipantContextIfNeeded, { participant: p }, children != null ? children : /* @__PURE__ */ React97.createElement(React97.Fragment, null, /* @__PURE__ */ React97.createElement(AudioTrack, { source: source != null ? source : Track8.Source.Microphone }), /* @__PURE__ */ React97.createElement(AudioVisualizer, null), /* @__PURE__ */ React97.createElement("div", { className: "lk-participant-metadata" }, /* @__PURE__ */ React97.createElement("div", { className: "lk-participant-metadata-item" }, /* @__PURE__ */ React97.createElement(TrackMutedIndicator, { source: Track8.Source.Microphone }), /* @__PURE__ */ React97.createElement(ParticipantName, null)), /* @__PURE__ */ React97.createElement(ConnectionQualityIndicator, { className: "lk-participant-metadata-item" })))));
}
...
import { isEqualTrackRef, isTrackReference as isTrackReference4, isWeb, log as log13 } from "@livekit/components-core";
...
function ControlBar(_a) {
  ...
  ))), visibleControls.camera && /* @__PURE__ */ React105.createElement("div", { className: "lk-button-group" }, /* @__PURE__ */ React105.createElement(TrackToggle, { source: Track10.Source.Camera, showIcon, onChange: cameraOnChange }, showText && "Camera"), /* @__PURE__ */ React105.createElement("div", { className: "lk-button-group-menu" }, /* @__PURE__ */ React105.createElement(
    MediaDeviceMenu,
    {
      kind: "videoinput",
...
// src/index.ts
import { setLogLevel, setLogExtension, isTrackReference as isTrackReference5 } from "@livekit/components-core";
export {
  AudioConference,
  AudioTrack,
  AudioVisualizer,
  ...
  isTrackReference5 as isTrackReference,
  setLogExtension,
  setLogLevel,
  useAudioPlayback,
  useChat,
